...
class Class14(BaseModel):
    __root__: Literal["Class14"] = "Class14"
...
class Class36(BaseModel):
    ...
    field101: constr(regex="^([0-9]+\\.){2}(\\*|[0-9]+)(-.*)?") = Field(..., alias="field101")
...
class Class53(Class35):
    ...
    field173: datetime = Field(..., alias="field173", description="", example="")
...
class Class60(Class35, Class28):
    ...
    field190: datetime = Field(..., alias="field190", description="", example="")
    field191: datetime = Field(..., alias="field191", description="", example="")
    field171: Class61
...
class Class65(Class35):
    ...
    field116: datetime = Field(..., alias="field116", description="")
...
class Class66(Class35):
    ...
    field221: list[float] = Field(..., alias="field221", description="", max_items=6, min_items=6)
...
class Class68(Class35):
    ...
    field116: datetime = Field(..., alias="field116")
    field225: float = Field(..., alias="field225", description="", example=1.1)
    field226: float = Field(..., alias="field226", description="", example=1.1)
...
class Class69(Class35):
    ...
    field227: str = Field(..., alias="field227", example=16908)
...
class Class70(Class35, Class28):
    ...
    field233: datetime = Field(..., alias="field233", description="", example="")
    field234: float = Field(..., alias="field234", description="", example=1.0)
    field198: Optional[Class8] = Field(None, alias="field198")
    ...
    field247: int = Field(..., alias="field247", description="", example=1)
    field172: Optional[AnyClass130] = None
    field248: constr(regex="[a-f0-9]{8}(?:-[a-f0-9]{4}){4}[a-f0-9]{8}") = Field(
...
class Class91(Class52):
    ...
    field270: list[str] = Field(..., alias="field270", description="", min_items=1)
...
class Class93(Class52):
    ...
    field272: list[str] = Field(..., alias="field272", description="", min_items=1)
...
class Class95(Class52):
    ...
    field275: datetime = Field(..., alias="field275", description="", example="")
...
class Class97(Class53):
    ...
    field224: Optional[Class6] = Field(None, alias="field224")
    field284: float = Field(..., alias="field284", description="", example=1.1)
    field285: Optional[float] = Field(None, alias="field285", description="", example=1.1)
    field286: float = Field(..., alias="field286", description="", example=1.1)
...
class Class107(Class55):
    ...
    field307: int = Field(..., alias="field307", example=6)
...
class Class111(Class57):
    ...
    field317: float = Field(..., alias="field317", description="", example=1.0)
    field318: float = Field(..., alias="field318", description="", example=30.0)
    field319: float = Field(..., alias="field319", description="", example=20.0)
...
class Class114(Class58):
    ...
    field342: float = Field(..., alias="field342", description="", example=3.0)
...
class Class118(Class59):
    ...
    field367: list[Class65] = Field(..., alias="field367", description="", min_items=1)
