...
class Class14(BaseModel):
  __root__: Literal["DEGREES"] = "DEGREES"
...
class Class26(Class23):
  ...
  field109: datetime = Field(..., description="", example="")
...
class Class28(BaseModel):
  ...
  field107: Optional[constr(min_length=1, max_length=36)] = Field(None, description="", example="")
  field115: Optional[constr(min_length=0, max_length=64)] = Field(None, description="", example="")
...
class Class33(BaseModel):
  __root__: Union[Class26, Class29] = Field(..., discriminator="modelType")
...
class Class36(BaseModel):
  ...
  field_101: constr(regex="^([0-9]+\\.){2}(\\*|[0-9]+)(-.*)?") = Field(..., alias="field101")
...
class Class39(BaseModel):
  __root__: Union[Class78, Class79, Class80, Class81, Class82] = Field(
...
class Class41(BaseModel):
  __root__: Union[Class96, Class97, Class98] = Field(..., discriminator="modelType")


class Class42(BaseModel):
  __root__: Union[Class99, Class100, Class101, Class102, Class103, Class104, Class105, Class106] = (
    Field(..., discriminator="modelType")
  )


class Class43(BaseModel):
  __root__: Union[Class107, Class121, Class108] = Field(..., discriminator="modelType")


class Class44(BaseModel):
  __root__: Union[Class109, Class110] = Field(..., discriminator="modelType")


class Class45(BaseModel):
  __root__: Union[Class74, Class75, Class76, Class77] = Field(..., discriminator="modelType")


class Class46(BaseModel):
  __root__: Union[Class111, Class112, Class113] = Field(..., discriminator="modelType")


class Class47(BaseModel):
  __root__: Union[Class114, Class115, Class116, Class117] = Field(..., discriminator="modelType")


class Class48(BaseModel):
  __root__: Union[Class118, Class119, Class120] = Field(..., discriminator="modelType")


class Class49(Class35, Class28):
  modelType: Literal["Class49"] = "Class49"
  field159: constr(min_length=0, max_length=128) = Field(..., description="", example="")
...
class Class53(Class35):
  ...
  field_173: datetime = Field(..., alias="field173", description="", example="")
...
class Class59(Class35, Class28):
  ...
  field_186: Optional[list[Class60]] = Field(None, alias="field186")
  field175: Optional[Class69] = Field(None, description="")
  field118: str = Field(..., description="", example="")
...
class Class60(Class35, Class28):
  ...
  field_190: datetime = Field(..., alias="field190", description="", example="")
  field_191: datetime = Field(..., alias="field191", description="", example="")
  field171: Class61
  ...
  field107: constr(min_length=1, max_length=36) = Field(..., description="", example="")
...
class Class61(Class35, Class28):
  ...
  field197: int = Field(..., description="", example=1)
...
class Class65(Class35):
  ...
  field_116: datetime = Field(..., alias="field116", description="")
...
class Class66(Class35):
  ...
  field_221: list[float] = Field(..., alias="field221", description="", max_items=6, min_items=6)


class Class67(Class35):
  modelType: Literal["Class67"] = "Class67"
  field_222: list[Class66] = Field(..., alias="field222", description="", max_items=6, min_items=6)
...
class Class68(Class35):
  ...
  field_116: datetime = Field(..., alias="field116")
  field_225: float = Field(..., alias="field225", description="", example=1.1)
  field_226: float = Field(..., alias="field226", description="", example=1.1)
...
class Class69(Class35):
  ...
  field_227: str = Field(..., alias="field227", example=16908)
  ...
  field_231: Optional[confloat(ge=0.0)] = Field(None, alias="field231", description="", example=2.1)
...
class Class70(Class35, Class28):
  ...
  field_233: datetime = Field(..., alias="field233", description="", example="")
  field_234: float = Field(..., alias="field234", description="", example=1.0)
  field_198: Optional[Class8] = Field(None, alias="field198")
  field_235: Optional[constr(regex="[a-f0-9]{8}(?:-[a-f0-9]{4}){4}[a-f0-9]{8}")] = Field(
    None, alias="field235"
  )
  field159: Optional[constr(min_length=0, max_length=128)] = Field(None, description="", example="")
  ...
  field_247: int = Field(..., alias="field247", description="", example=1)
  field172: Optional[AnyClass130] = None
  field_248: constr(regex="[a-f0-9]{8}(?:-[a-f0-9]{4}){4}[a-f0-9]{8}") = Field(
...
class Class88(Class52):
  ...
  field_266: Optional[confloat(ge=-360.0, le=360.0)] = Field(None, alias="field266", description="")
...
class Class90(Class52):
  ...
  field_265: Optional[confloat(ge=-360.0, le=360.0)] = Field(None, alias="field265", description="")
  field_266: Optional[confloat(ge=-360.0, le=360.0)] = Field(None, alias="field266", description="")


class Class91(Class52):
  modelType: Literal["Class91"] = "Class91"
  field_270: list[str] = Field(..., alias="field270", description="", min_items=1)
...
class Class93(Class52):
  ...
  field_272: list[str] = Field(..., alias="field272", description="", min_items=1)
...
class Class95(Class52):
  ...
  field_275: datetime = Field(..., alias="field275", description="", example="")
...
class Class97(Class53):
  ...
  field_224: Optional[Class6] = Field(None, alias="field224")
  field_284: float = Field(..., alias="field284", description="", example=1.1)
  field_285: Optional[float] = Field(None, alias="field285", description="", example=1.1)
  field_286: float = Field(..., alias="field286", description="", example=1.1)
...
class Class107(Class55):
  ...
  field_307: int = Field(..., alias="field307", example=6)
...
class Class111(Class57):
  ...
  field_317: float = Field(..., alias="field317", description="", example=1.0)
  field_318: float = Field(..., alias="field318", description="", example=30.0)
  field_319: float = Field(..., alias="field319", description="", example=20.0)
...
class Class114(Class58):
  ...
  field_342: float = Field(..., alias="field342", description="", example=3.0)
...
class Class118(Class59):
  ...
  field_367: list[Class65] = Field(..., alias="field367", description="", min_items=1)
...
class Class120(Class59):
  ...
  field369: Optional[constr(min_length=0, max_length=69)] = Field(None, description="", example="")
  field370: constr(min_length=0, max_length=69) = Field(..., description="", example="")
  field371: constr(min_length=0, max_length=69) = Field(..., description="", example="")
...
AnyClass129 = Annotated[Union[Class74, Class75, Class76, Class77], Field(discriminator="modelType")]
