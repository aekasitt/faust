...
class Class43(BaseModel):
  __root__: Optional[Union[Class107, Class121, Class108]] = Field(None, discriminator="modelType")
...
class Class46(BaseModel):
  __root__: Optional[Union[Class111, Class112, Class113]] = Field(None, discriminator="modelType")
...
class Class48(BaseModel):
  __root__: Optional[Union[Class118, Class119, Class120]] = Field(None, discriminator="modelType")
...
class Class120(Class59):
  ...
  field370: Optional[constr(min_length=0, max_length=69)] = Field(None, description="", example="")
  field371: Optional[constr(min_length=0, max_length=69)] = Field(None, description="", example="")
