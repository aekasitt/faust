...
class Class32(BaseModel):
  ...
  field_138: Optional[Class14] = Field(None, alias="field138", description="", examples=["DEGREE"])
...
class Class39(RootModel):
  root: Union[Class78, Class79, Class80, Class81, Class82] = Field(..., discriminator="model_type")
...
class Class60(Class35, Class28):
  ...
  field107: constr(min_length=1, max_length=36) = Field(..., description="", examples=["Bluestaq"])
...
class Class66(Class35):
  ...
  field_221: list[float] = Field(..., alias="field221", description="", max_length=6, min_length=6)
